<div class="navbar">
	<div class="logo_div">
		<a href="index.php" class="logo-image">
			<img src="<?php echo BASE_URL . '/static/images/logo.jpeg'; ?>" style="border-radius: 5px; float: left; margin-right:10px !important;" width="80px" height="60px" alt="logo-image"/>
	...
	<ul>
	  ...
	  <li style="background-color: #000;" class="<?php echo $num<1 ? 'd-none' : ''?>"><a href="tenant_invoice.php?user_id=<?php echo $_SESSION['user']['id'] ?>&house_slug=<?php echo $house_slug; ?>">Account</a></li>
