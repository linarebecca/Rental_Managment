...
<div class="container">
	...
	<div style="width: 40%; margin: 20px auto;">
		<form method="post" action="rent_payment.php" >
			...
			<input type="text" name="user_id" value="<?php echo $_SESSION['user']['id'] ?>"  placeholder="id">
			<?php } ?>
			...
			<input type="text" name="amount" value="<?php echo $house['price']; ?>" placeholder="Deposit Amount" readonly>
